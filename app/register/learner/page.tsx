      ...
      <div className="w-1/2 relative overflow-hidden flex flex-col px-12 py-10 bg-gradient-to-br from-[#e6edfc] via-[#fcfcfd] to-[#fce4d2] border-r border-[#e1e2ec]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center flex-1 gap-8 text-center mt-8">
          ...
          <p className="text-[14px] leading-relaxed max-w-[240px] text-[#44474f] font-medium">
            Create your learner account in just a few steps.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md px-10 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            {otpSent && !otpVerified && (
              <div className="flex flex-col gap-2 mt-1 mb-1 animate-in fade-in slide-in-from-top-2 duration-400">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1 flex items-center gap-3 rounded-[16px] px-4 py-3 transition-colors duration-200 bg-white border border-[#e1e2ec] focus-within:border-[#2251cc] focus-within:ring-2 focus-within:ring-[#2251cc]/10">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-3 rounded-[16px] px-4 py-3 bg-[#f4f4f8] transition-all duration-200 focus-within:outline focus-within:outline-2 focus-within:outline-[#2251cc]">
          ...
          <button
            onClick={() => {
              if (canSubmit) {
                ...
                router.push("/register/learner/verify");
              }
            }}
