...
export default function TutorRegisterPage() {
  ...
  function getOutline(val: string, valid: boolean, t: boolean) {
    if (!val) return "2px solid transparent";
    if (t && !valid) return "2px solid #c0392b";
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <LeftPanel bg={PRIMARY_LIGHT} primary={PRIMARY} onPrimaryContainer="#2d1600"
        line1="Share what" line2="you know best."
        sub="Join hundreds of tutors already earning on HomeGuru." />
      ...
      <div className="w-1/2 bg-[#fafafa] flex items-center justify-center">
        <div className="w-full max-w-md px-10 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                {phone && (phoneValid
                  ? <CheckCircle size={18} color={PRIMARY} weight="fill" />
                  : touched.phone && <WarningCircle size={18} color="#c0392b" weight="fill" />
                )}
              </div>
              {phoneError && <p className="text-[11.5px] text-[#c0392b] flex items-center gap-1"><WarningCircle size={13} weight="fill" />Enter a valid phone number</p>}
          ...
          <button
            onClick={() => canSubmit && router.push("/register/tutor/otp")}
